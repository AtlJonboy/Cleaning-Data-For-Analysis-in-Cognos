...
# Step 2: Extract just the WebframeWantToWorkWith values into a single column CSV
LANG_COL = "WebframeWantToWorkWith"
OUTPUT_VALUES_ONLY = "WebFrameWantToValues Only.csv"
...
# Write to a new CSV with a single column named 'WebFrame'
langs_df = pd.DataFrame({"WebFrame": langs_series})
