...
# Step 2: Extract just the PlatformWantToWorkWith values into a single column CSV
LANG_COL = "PlatformWantToWorkWith"
OUTPUT_VALUES_ONLY = "PlatformWantToValues Only.csv"
...
# Write to a new CSV with a single column named 'Platform'
langs_df = pd.DataFrame({"Platform": langs_series})
